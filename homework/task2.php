...
if (!empty($_POST)) {
	$year = (int)(isset($_POST['years'])? $_POST['years'] : '');
	$month = (int)(isset($_POST['month'])? $_POST['month'] : '');
	$date =(int)( isset($_POST['date'])? $_POST['date'] : '');
	$hour = (int)(isset($_POST['hour'])? $_POST['hour'] : '');
	$min = (int)(isset($_POST['min'])? $_POST['min'] : '');
	$sec = (int)(isset($_POST['sec'])? $_POST['sec'] : '');
	
	$year1 = (int)(isset($_POST['year1'])? $_POST['year1'] : '');
	$month1 = (int)(isset($_POST['month1'])? $_POST['month1'] : '');
	$date1 = (int)(isset($_POST['date1'])? $_POST['date1'] : '');
	$hour1 = (int)(isset($_POST['hour1'])? $_POST['hour1'] : '');
	$min1 = (int)(isset($_POST['min1'])? $_POST['min1'] : '');
	$sec1 = (int)(isset($_POST['sec1'])? $_POST['sec1'] : '');
